    ...
    public partial class initial_3 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CountryGroupPosCompany",
                columns: table => new
                {
                    CountryGroupsId = table.Column<long>(type: "bigint", nullable: false),
                    PosCompaniesId = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CountryGroupPosCompany", x => new { x.CountryGroupsId, x.PosCompaniesId });
                    table.ForeignKey(
                        name: "FK_CountryGroupPosCompany_CountryGroup_CountryGroupsId",
                    ...
                    table.ForeignKey(
                        name: "FK_CountryGroupPosCompany_PosCompanies_PosCompaniesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CountryGroupPosCompany_PosCompaniesId",
                table: "CountryGroupPosCompany",
                column: "PosCompaniesId");
        }
